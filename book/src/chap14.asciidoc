...
(((DBM)))((("tipo", "PiensaEnJulia", "DBM", see="DBM")))
...
Si hizo <<ex12-2>>, recordará que debía crear un diccionario que asociaba una cadena ordenada de letras al conjunto de palabras que se podía deletrear con esas letras. Por ejemplo, +"cuaderno"+ estaba asociado a la matriz +["cuaderno", "educaron", "encuadro"]+.
