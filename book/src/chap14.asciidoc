...
La mayoría de los programas que hemos visto hasta ahora han sido transitorios, es decir se ejecutan por un corto tiempo y generan una salida, pero cuando terminan, sus datos desaparecen. Si ejecuta el programa nuevamente, este comienza de cero.
(((transient)))
...
. Para verificar por segunda vez, puede usar el comando de Unix +diff+.
