...
PiensaEnJulia proporciona una interfaz para +GDBM+ (GNU dbm), que permite crear y actualizar archivos de base de datos. A modo de ejemplo, crearemos una base de datos que contenga títulos para archivos de imagen.
(((GDBM)))
