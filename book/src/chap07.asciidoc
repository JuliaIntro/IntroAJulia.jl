...
[WARNING]
====
Reasignar variables puede ser útil, pero se debe hacer con precaución. Si los valores cambian frecuentemente, puede hacer que el código sea difícil de leer y depurar.
