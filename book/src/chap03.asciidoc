...
Este segundo ejemplo encuentra la razón seno de +radianes+. El nombre de esta variable es una pista de que +sin+ y las otras funciones trigonométricas (+cos+, +tan+, etc.) toman argumentos en radianes. Para convertir grados a radianes, divida por 180 y multiplique por latexmath:[\(\pi\)]:
