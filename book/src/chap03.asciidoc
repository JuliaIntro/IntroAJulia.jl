...
* Las funciones pueden hacer que un programa sea más pequeño al eliminar código repetitivo. Además, si realiza un cambio, solo tiene que hacerlo en un solo lugar.

* Dividir un programa largo en funciones le permite depurar las partes de a una y luego unirlas.

* Las funciones bien diseñadas a menudo son útiles para muchos programas. Una vez que escribe y depura uno, puede reutilizarla.
