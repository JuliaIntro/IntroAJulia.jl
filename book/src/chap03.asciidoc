...
Algunas de las funciones que hemos visto requieren argumentos. Por ejemplo, la función +sin+ necesita un número como argumento. Algunas funciones toman más de un argumento; +parse+ toma dos: un número y una cadena.
