...
Ahora mueva la llamada a función hacia abajo y coloque la definición de +imprimirletras+ después de la definición de +repetirletras+. ¿Qué sucede cuando ejecutas este programa?
...
En resumen, cuando lee un programa, no siempre debes leer de arriba hacia abajo. A veces tiene más sentido seguir el flujo de ejecución.
