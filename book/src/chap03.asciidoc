...
Cada parámetro se refiere al mismo valor que su argumento correspondiente. Entonces, +parte1+ tiene el mismo valor que +line1+, +part2+ tiene el mismo valor que +line2+, y +bruce+ tiene el mismo valor que +concat+.
...
Un objeto de función es un valor que se puede asignar a una variable o pasarlo como argumento. Por ejemplo, +dosveces+ es una función que toma un objeto de función como argumento y lo llama dos veces:
