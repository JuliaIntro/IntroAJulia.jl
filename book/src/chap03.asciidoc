...
En el contexto de la programación, una _función_ es una secuencia de sentencias que realiza un cálculo. Las funciones tienen nombre. Cuando se define una función, se especifica su nombre y su secuencia de sentencias. Una vez hecho esto, se puede "llamar" a la función por su nombre.
(((función)))
