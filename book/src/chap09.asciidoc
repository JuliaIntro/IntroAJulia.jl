...
Por lo general, las pruebas pueden ayudarlo a encontrar errores, pero no es fácil generar un buen conjunto de instancias de prueba, e incluso si lo hace, no puede estar seguro de que su programa sea correcto. Según un legendario informático:
(((Dijkstra, Edsger W.)))
...
A continuación se muestra un puzzle de _Car Talk_ (https://www.cartalk.com/puzzler/browse):
