...
Las primeras líneas contienen información sobre el REPL, por lo que esto puede lucir diferente. Debe verificar que la versión sea al menos `1.0.0`.
...
Después de ((("operadores", "aritmética"))) (((("operadores aritméticos"))) ((("matemáticas", "operadores aritméticos"))) "¡Hola, Mundo!", el siguiente paso es la aritmética. Julia ((("operadores"))) tiene _operadores_, los cuales son símbolos que representan cálculos como la suma y la multiplicación.
...
Quizás se pregunte por qué el resultado es `42.0` en vez de `42`. Lo explicaré en la siguiente sección.
