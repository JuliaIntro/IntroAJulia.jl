...
El objetivo de ((("informáticos, habilidades de", seealso = "programación"))) de este libro es enseñarle a pensar como un informático. Esta forma de pensar combina algunas de las mejores características de las matemáticas, la ingeniería y las ciencias naturales. Al igual que los matemáticos, los informáticos usan lenguajes formales para denotar ideas (específicamente cálculos). Al igual que los ingenieros, diseñan cosas, ensamblan componentes en sistemas y evalúan las compensaciones entre alternativas. Como los científicos, observan el comportamiento de sistemas complejos, forman hipótesis y prueban predicciones.
...
En un nivel, aprenderás a programar, una habilidad útil por sí misma. En otro nivel, utilizará la programación como un medio para un fin. A medida que avanzamos, ese final se hará más claro.
