...
Literalidad ::
Los lenguajes naturales están llenos de modismos y metáforas. Si digo: "Me cayó la teja", probablemente no haya ni una teja y nada se caiga (este modismo chileno significa que alguien entendió algo después de un período de confusión). Los idiomas formales significan exactamente lo que dicen.
...
bug::
Un error ((("errores (errores)", seealso="depuración")))((("errores", see="errores")))en un programa.
