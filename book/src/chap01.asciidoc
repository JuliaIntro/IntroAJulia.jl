...
Lo creas o no, eso es todo lo que hay que hacer. Cada programa que has usado, sin importar su complejidad, está construido en base a instrucciones que se parecen bastante a estas. De esta manera, la programación puede entenderse como el proceso de dividir una compleja y larga tarea en pequeñas subtareas, lo suficientemente simples para ser representadas con una de estas instrucciones básicas.
