...
bug::
Un error ((("errores (bugs)", seealso="depuración")))((("errores", see="errores")))en un programa.

depuración/debugging ::
El proceso ((("depuración", seealso = "errores (bugs); prueba"))) de búsqueda y corrección de errores.
