...
El lado izquierdo es una tupla de variables; el lado derecho es una tupla de expresiones. Cada valor se asigna a su respectiva variable. Todas las expresiones en el lado derecho se evalúan antes de cualquiera de las asignaciones.

El número de variables de la izquierda tiene que ser menor que el número de valores a la derecha:
(((BoundsError)))
