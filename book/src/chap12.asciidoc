...
. Es posible que desee escribir una función que tome una palabra y calcule una matriz de todas las palabras que se pueden formar al eliminar una letra. Estos son los "hijos" de la palabra.
...
. La lista de palabras _palabras.txt_ no tiene la cadena vacía, por lo que tendrías que agregarla.
