...
Este enfoque puede ser efectivo, especialmente si aún no se tiene un conocimiento profundo del problema. Pero las correcciones incrementales pueden generar un código innecesariamente complicado (que considere muchos casos especiales) y poco confiable (es difícil saber si ha encontrado todos los errores).
