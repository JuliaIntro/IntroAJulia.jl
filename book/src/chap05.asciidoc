...
Para escribir programas útiles, generalmente necesitamos poder verificar las condiciones y cambiar el comportamiento del programa acorde a ellas. Las sentencias condicionales nos permiten esto. La forma más simple es la sentencia +if+:
