...
El tema principal de este capítulo es la sentencia +if+, que ejecuta diferentes códigos dependiendo del estado del programa. Primero se presentarán dos nuevos operadores: división de piso y módulo.
...
Para obtener el resto de la operación, se puede restar una hora (en minutos) a la duración total de la película:
