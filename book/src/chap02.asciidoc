...
+
Identificar errores semánticos puede ser complicado porque requiere que trabajes en reversa, analizando el output del programa para intentar descubrir qué está haciendo.
...
sentencia::
Una sección de código que representa un comando o acción. Hasta ahora, las sentencias que hemos visto son asignaciones y declaraciones impresas.
(((sentencia)))
...
Practique usando el Julia REPL como una calculadora:
(((calculadora)))
...
. Si salgo de mi casa a las 6:52 a.m. y corro 1 milla a un ritmo relajado (8:15 por milla), luego 3 millas más rápido (7:12 por milla) y 1 milla a ritmo relajado nuevamente, ¿a qué hora llego a casa para desayunar?
