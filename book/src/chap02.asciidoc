...
. En algunos lenguajes, cada declaración termina con un punto y coma, +;+. ¿Qué sucede si pones un punto y coma al final de una sentencia en Julia?
(((pass:[;])))

. ¿Qué pasa si pone un punto al final de una sentencia?

. En notación matemática puedes multiplicar +x+ y +y+ de esta manera: +x y+. ¿Qué pasa si intentas eso en Julia? ¿Y 5x?
