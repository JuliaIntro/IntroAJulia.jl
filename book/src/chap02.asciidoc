...
A medida que los programas se hacen más grandes y más complejos, se vuelven más difíciles de leer. Los lenguajes formales son densos, y a menudo es difícil mirar un código y descubrir qué está haciendo o por qué.
...
En este caso, el comentario aparece en una línea. También puede poner comentarios al final de una línea:
