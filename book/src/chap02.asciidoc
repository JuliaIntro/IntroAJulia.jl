...
Cuando una expresión contiene más de un operador, el orden de evaluación depende del _orden de operaciones_. Para los operadores matemáticos, Julia sigue la convención matemática. El acrónimo _PEMDAS_ es una forma útil de recordar las reglas:
