...
Las matrices pueden aparecer como valores en un diccionario. Por ejemplo, si le dan un diccionario que asigna de letras a frecuencias, es posible que desee invertirlo; es decir, cree un diccionario que mapee de frecuencias a letras. Dado que puede haber varias letras con la misma frecuencia, cada valor en el diccionario invertido debe ser una matriz de letras.
