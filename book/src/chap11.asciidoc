...
Si hizo <<ex10-7>>, ya tiene una función llamada + hasduplicates + que toma una matriz como parámetro y devuelve + true + si hay algún objeto que aparece más de una vez en la matriz.
