...
El tipo de este diccionario está compuesto por el tipo de las llaves y de los valores. En este caso, las llaves y los valores son de tipo +Any+.
(((curly braces)))((("{}", see="curly braces")))(((Any)))((("type", "Base", "Any", see="Any")))

El diccionario está vacio. Para agregar elementos al diccionario, se pueden usar corchetes:
(((square brackets)))
...
Este formato de salida también es un formato de entrada. Por ejemplo, puedes crear un nuevo diccionario con tres items:
...
Esto no es un problema ya que los elementos de un diccionario nunca se indexan con índices enteros. En lugar de eso, se utilizan las claves para buscar los valores correspondientes:
