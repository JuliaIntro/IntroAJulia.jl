...
En la primera iteración del bucle, el valor de +j+ es 3, pero tiene que ser 4. Esto se puede solucionar moviendo + j = prevind (palabra2, j) + al final del ciclo + while +.
