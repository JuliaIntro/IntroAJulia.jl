...
Definir lo que significa un carácter es altamente complejo. La _norma Unicode_ permite abordar este problema, y se considera como el estándar definitivo para ello. La _norma Unicode_ funciona asignando un número único para cada carácter a nivel global.
(((Unicode standard)))
