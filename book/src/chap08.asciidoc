...
Continuando este ejemplo, ¿qué cree que significa +str[:]+? Prueba y verá.
...
Julia no maneja las letras mayúsculas y minúsculas del mismo modo que son manejada en cualquier lengua hablada. Todas las letras mayúsculas van antes de las letras minúsculas, según el estándar de codificación. Por lo tanto:
