...
(((])))(((IntroAJulia)))((("modulo", véase "IntroAJulia")))
...
(((Turtle)))((("tipo", "Luxor", "Turtle", véase "Turtle")))
...
(((forward)))((("función", "IntroAJulia", "forward", véase "forward")))
...
(((@svg)))((("macro", "Luxor", "@svg", véase "@svg")))(((macro)))(((SVG picture)))
...
(((turn)))((("función", "IntroAJulia", "turn", véase "turn")))
...
(((penup)))((("función", "IntroAJulia", "penup", véase "penup")))(((pendown)))((("función", "IntroAJulia", "pendown", véase "pendown")))
...
(((cuadrado)))((("función", "definida por el programador", "cuadrado", véase "cuadrado")))
...
(((polígono)))((("función", "definida por el programador", "polígono", véase "polígono")))
...
(((círculo)))((("función", "definida por el programador", "círculo", véase "círculo")))
...
(((arco)))((("función", "programmer-defined", "arco", véase "arco")))
...
(((polyline)))((("función", "definida por el programador", "polyline", véase "polyline")))
...
(((docstring)))(((comillas triples)))((("&quot;&quot;&quot;", véase "comillas triples")))
...
. La versión de +arco+ en <<refactorización>> no es muy precisa ya que la aproximación lineal del círculo siempre queda por afuera del círculo verdadero. Como resultado, la tortuga termina a unos pocos píxeles del destino correcto. La siguiente solución muestra una forma de reducir el efecto de este error. Lea el código y vea si tiene sentido. Si dibuja un diagrama, es posible que entienda mejor cómo funciona.
(((arco)))
