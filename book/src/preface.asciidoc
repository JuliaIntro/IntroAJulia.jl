...
- Julia usa envío múltiple (“multiple dispatch” en ingles), que le permite al programador elegir entre diferentes patrones de programación de acuerdo a la aplicación.
