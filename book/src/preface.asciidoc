...
Julia fue lanzada originalmente en 2012 por Alan Edelman, Stefan Karpinski, Jeff Bezanson y Viral Shah. Es un lenguaje de programación gratuito y de código abierto.

Elegir un lenguaje de programación es siempre subjetivo. Para mí, las siguientes características de Julia son decisivas:
