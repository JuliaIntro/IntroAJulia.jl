...
Un _argumento opcional_ llamado _delimitador_ especifica qué caracteres usar como límites de las palabras. El siguiente ejemplo usa un guión como delimitador:
...
En este caso, el delimitador es un carácter de espacio. Para concatenar cadenas sin espacios, no especifique un delimitador.
