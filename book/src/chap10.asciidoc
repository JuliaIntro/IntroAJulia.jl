...
Al igual que una cadena, una _matriz_ es una secuencia de valores. En una cadena los valores son caracteres, en una matriz pueden ser de cualquier tipo. Los valores en una matriz se denominan _elementos_ o, a veces, _items_.
(((array)))(((element)))(((item)))
...
Cualquier función +f+ de Julia puede ser aplicada en cada elemento de cualquier matriz con la _sintaxis de punto_. Por ejemplo, para poner en mayúsculas una matriz de cadenas, no se necesita un bucle explícito:
(((dot syntax)))
