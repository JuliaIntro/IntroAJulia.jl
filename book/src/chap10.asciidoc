...
Dos palabras se "entrelazan" si al unir las letras de cada una se forma una nueva palabra. Por ejemplo, "gama" y "rana" se entrelazan para formar "anagrama".
(((interlock)))
...
. ¿Puedes encontrar alguna palabra que esté entrelazada en tres direcciones? es decir, cada tercera letra forma una palabra, comenzando por la primera, segunda o tercera.
