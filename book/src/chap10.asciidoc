...
Cualquier función +f+ de Julia se puede aplicar elemento a elemento en cualquier matriz con la _sintaxis de punto_. Por ejemplo, para poner en mayúsculas una matriz de cadenas, no se necesita un bucle explícito:
(((dot syntax)))
