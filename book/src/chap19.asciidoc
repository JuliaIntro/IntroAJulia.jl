...
operador ternario::
Operador de flujo de control que toma tres operandos para especificar una condición: una expresión que se ejecutará cuando la condición produzca +true+ y una expresión que se ejecutará cuando la condición produzca + falso +.
