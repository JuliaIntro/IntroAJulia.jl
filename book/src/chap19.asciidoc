...
Uno de los objetivos de este libro es enseñarle lo justo y necesario de Julia. Si habían dos formas de hacer algo, se elegió una y se evitó mencionar la otra. En ocasiones, la segunda manera se dejó como ejercicio al lector.
