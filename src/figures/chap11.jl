function fig11_1(output::Symbol, font::String, scale::Float64)
  ...
  \node[anchor=east](o) at (-0.5, 1) {\tt 'e'};
  \node[anchor=west](ov) at (0.5, 1) {\tt 1};
  \draw[-latex] (o)--(ov);
  \node[anchor=east](a) at (-0.5, 0.5) {\tt 'p'};
  \node[anchor=west](av) at (0.5, 0.5) {\tt 1};
  \draw[-latex] (a)--(av);
  \node[anchor=east](p) at (-0.5, 0) {\tt 's'};
  \node[anchor=west](pv) at (0.5, 0) {\tt 1};
  \draw[-latex] (p)--(pv);
  \node[anchor=east](t) at (-0.5, -0.5) {\tt 'o'};
  ...
  \node[anchor=west](v1) at(7.25, 1.25){\tt 'e'};
  \node[anchor=west](v2) at(7.25, 0.75){\tt 'p'};
  \node[anchor=west](v3) at(7.25, 0.25){\tt 's'};
  \node[anchor=west](v4) at(7.25, -0.25){\tt 'o'};
